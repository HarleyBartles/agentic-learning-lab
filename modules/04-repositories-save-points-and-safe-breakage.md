...
Status: fluid. Preserve the connection back to Lab 1 even if this module is later reordered or rewritten.
...
In Lab 1, the learner completed the cloud version of the mission and then casually deleted `output/mission-brief.md` before asking Codex to do the same mission locally.
